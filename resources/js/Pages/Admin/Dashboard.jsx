                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500">Organize your products</p>
                            </div>
                        </Link>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500">Add and edit products</p>
                            </div>
                        </Link>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500">Approve and manage vendors</p>
                            </div>
                        </Link>
                    </div>
                </div>
